...
class Team_RNN(Team):
    ...
    def __init__(self, env, n_env, memory, n_agent, training_method, h_stable_at, discount=0.99, cen_mode=0, sample_epi=False, 
    ...
    def get_next_actions(self, joint_obs, h_state, last_valid, eval=False):
        with torch.no_grad():
